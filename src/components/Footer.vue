...
<template>
  <footer class="footer">
    ...
    <p class="made-by">Made by <a href="https://www.coodaa.de" target="_blank" rel="noopener noreferrer">coodaa</a></p>
  </footer>
</template>
...
<style scoped>
.footer {
  background-color: var(--blue); /* Dunkelblauer Hintergrund */
...
.social-media a:hover {
  color: var(--gold); /* Goldene Farbe beim Hover */
}
...
@media (max-width: 767px) {
  .footer-links {
    flex-direction: column; /* Links untereinander auf mobilen Geräten */
    gap: 0.5rem;
  }
}
